...
class Ponto {
    ...
    /**
     * Verifica se o ponto atual é colinear com dois outros pontos.
     * Usa o método `onSegment` da classe `Segmento` para verificar se o ponto está no segmento formado por `a` e `b`.
     *
     * @param a O primeiro ponto.
     * @param b O segundo ponto.
     * @return true se os pontos forem colineares, caso contrário false.
     */
    public boolean colinear(Ponto a, Ponto b) {
        return new Segmento(a, b).onSegment(this, a, b);
    }

    /**
     * Retorna uma representação em string do ponto, em coordenadas cartesianas.
     *
